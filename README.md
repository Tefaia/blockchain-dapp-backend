...
DEPLOYED on CLOUD with Automactic startup. No need to run in the Droplet console and start each componet Blockchain, Backend and frontend separately anymore. im only using incognito due cache issues with my browser. http://209.38.153.171:3000
